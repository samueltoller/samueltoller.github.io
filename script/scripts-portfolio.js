    ...
    $panel.each(function () {
      ...
      if ($this.position().top <= scroll && $this.position().top + $this.height() > scroll) {
        ...
        $body.removeClass(function (index, css) {
          return (css.match (/(^|\s)colore-\S+/g) || []).join(' ');
        });
         
        // Add class of currently active div
        $body.addClass('colore-' + $(this).data('color'));
        document.getElementById("colore-due").classList.remove("questo");
        document.getElementById("colore-tre").classList.remove("questo");
        document.getElementById("colore-quattro").classList.remove("questo");
        document.getElementById("colore-cinque").classList.remove("questo");
        document.getElementById("colore-sei").classList.remove("questo");
        document.getElementById("colore-sette").classList.remove("questo");
        if($(this).data('color') != "uno"){
            document.getElementById("colore-" + $(this).data('color')).classList.add("questo");
        }
      }
    });    
